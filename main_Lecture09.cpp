...
int main()
{
    ...
    *******************/
    ...
    ldmarkmodel modelt;
    std::string modelFilePath = "roboman-landmark-model.bin";//roboman..ÆÄÀÏÀÌ ÀÖ´Â À§Ä¡
    ...
    for (;;) {
        ...
        int numLandmarks = current_shape.cols / 2;//numLandmarks ·£µå¸¶Å© ¼ö
...
//github¿¡¼­ ´Ù¿î ¹ÞÀº tree ±¸Á¶ »ç¿ëÇÏ´Â ¹æ¹ý 
//opencv ¼³Á¤ÇÑ visual studio ÇÁ·ÎÁ§Æ®ÀÇ ¼Ó¼ºÃ¢ÀÌµ¿
//C/C++ÀÇ ÀÏ¹Ý Ãß°¡¶óÀÌºê·¯¸®¿¡ ´Ù¿î¹ÞÀº src/include¸¦ Ãß°¡